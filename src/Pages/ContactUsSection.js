    ...
    return(
        ...
        <div className="max-w-7xl mx-auto bg-[#FFFFFF] p-5 flex flex-col items-center md:flex-row justify-between rounded-[20px]">
          ...
          <div className="space-y-3 mt-4">
            ...
            <button className="bg-[#CBE26B] font-aileron text-lg font-semibold text-black w-[300px] lg:w-[550px] h-[60px] lg:h-[50px] xl:h-[60px] rounded-full flex justify-center items-center hover:bg-black transition duration-500 hover:text-white">Send A Message</button>
            </div>
          </div>
        </div>
      </div>
